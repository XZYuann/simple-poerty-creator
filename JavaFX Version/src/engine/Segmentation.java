...
public class Segmentation {
    ...
    //默认的语料库文件目录
    private static final String SRC = "./corpus_simple/Poetry_src.txt";
    private static final String OUT1 = "./corpus_simple/segmentation_1.txt";
    private static final String OUT2 = "./corpus_simple/segmentation_2.txt";
    ...
    public Segmentation(String srcFile){
        this(srcFile,OUT1,OUT2);
    }
...
//            System.out.println("poetry segmentation finished!");
    ...
    //获取默认源文件
    public static String getDefalutSrcFile(){
        return SRC;
    }
